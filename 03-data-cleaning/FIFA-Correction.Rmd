...
wwc_2[index_date,"date"]  <- as.Date("2019-06-09")
wwc_2
```
...
```{r}
# .... YOUR CODE FOR TASK 4 ....
wwc_2[index_venue,"venue"]  <-  "Groupama Stadium"
...
wwc_4  %>% 
  ...
  coord_flip() +  
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45,  hjust = 1))+ labs(title = "Distribution of attendance by stadium", subtitle = "2019 FIFA Women's World Cup", x = "Stadium", y = "Attendance")
